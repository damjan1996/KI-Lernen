            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {course.modules.map((module, index) => (
                <StaggerItem key={index}>
                  <Card className="h-full transition-colors hover:border-[var(--accent-gold)]/20">
                    <CardHeader>
              ...
              <ScaleOnHover>
                <Card className="text-center p-6 h-full">
                  <CardContent className="pt-6">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[var(--accent-gold)]/10 text-[var(--accent-gold)] mb-4 transition-transform group-hover:scale-110">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {course.testimonials.map((testimonial, index) => (
                <StaggerItem key={index}>
                  <Card className="p-6 h-full hover:border-[var(--accent-gold)]/20 transition-colors">
                    <CardContent className="pt-0">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <StaggerContainer className="max-w-3xl mx-auto space-y-4">
              {course.faqs.map((faq, index) => (
                <StaggerItem key={index}>
                  <Card className="p-6 hover:border-[var(--accent-gold)]/20 transition-colors">
